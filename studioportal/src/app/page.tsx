            ...
            <div className="flex flex-col gap-10">
              ...
              <div className="flex flex-col gap-6">
                <TrustItem
                  ...
                  desc="All data is encrypted with military-grade standards."
                />
                <TrustItem
                  icon={<Zap />}
                  title="Hyper-Performance"
                  desc="Built on Next.js 16 for sub-second page transitions."
                />
                <TrustItem
                  icon={<Lock />}
                  title="Access Control"
                  desc="Strict RBAC ensuring your internal data stays internal."
                />
              </div>
            </div>
