          ...
          <div className="mb-6 flex items-center gap-4">
            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-indigo-500 to-purple-600">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
                ...
                <path d="M5 8.5c1.5-2 3-3 7-3s5.5 1 7 3" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" opacity="0.85"/>
              </svg>
            </div>
            <div>
              <p className="mb-0 text-xs font-semibold uppercase tracking-widest text-zinc-500">StudioPortal Access</p>
              <h1 className="text-3xl font-bold tracking-tight text-white">Sign in</h1>
              <p className="mt-1 text-sm text-zinc-500">Continue to your agency workspace.</p>
            </div>
          </div>
